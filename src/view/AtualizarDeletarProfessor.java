 ...
 * @author Windows
 */
public class AtualizarDeletarProfessor extends javax.swing.JFrame {

    /**
     * Creates new form AtualizarDeletarProfessor
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Atualizar/Deletar Professor");
        ...
        getContentPane().add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 300, -1));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 330, 300, -1));
        ...
        getContentPane().add(jTextField11, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, 300, -1));
        ...
        getContentPane().add(lblPainel, new org.netbeans.lib.awtextra.AbsoluteConstraints(-70, -10, 840, 530));

        setSize(new java.awt.Dimension(751, 501));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("update professor set nome = ?, telefone = ?, endereco = ?, cpf = ?, idade = ? where id = ?");
            ps.setString(1, nome);
            if (telefone > 0){
            ...
            if (cpf > 0){
                ps.setString(4, cpfString);
            }
            if (idade > 0){
                ps.setString(5, idadeString);
            }
            ps.setString(6, id);
            ps.executeUpdate();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(a == 0){
            ...
            try{
                Connection con = ConnectionProvider.getCon();
                Statement st = con.createStatement();
                st.executeUpdate("delete from professor where id = '"+id+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtualizarDeletarProfessor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
