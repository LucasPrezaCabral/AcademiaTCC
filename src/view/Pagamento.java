...
public class Pagamento extends javax.swing.JFrame {
    ...
    public void realizarPagamento(){
        ...
        String mes = jLabel8.getText();
        String quantia = jTextField8.getText();
        try{
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("insert into pagamento values(?, ?, ?)");
            ps.setString(1, id);
            ps.setString(2, mes);
            ps.setString(3, quantia);
            ps.executeUpdate();
            tableDetails();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/payment.png"))); // NOI18N
        ...
        getContentPane().add(jTextField9, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 40, -1));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 300, -1));

        jTextField8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 390, 300, -1));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, 300, -1));

        jTextField5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, 300, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 140, 380, 320));

        lblPainel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Agenda-PainelFundo.png"))); // NOI18N
        getContentPane().add(lblPainel, new org.netbeans.lib.awtextra.AbsoluteConstraints(-80, -10, 870, 530));

        setSize(new java.awt.Dimension(749, 498));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            ResultSet rs1 = st.executeQuery("select * from pagamento inner join membro where pagamento.mes = '"+month+"' and pagamento.id = '"+id+"' and membro.id = '"+id+"'");
            while(rs1.next()){
                jButton2.setVisible(false);
                JOptionPane.showMessageDialog(null, "O pagamento deste mês está feito");
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }
