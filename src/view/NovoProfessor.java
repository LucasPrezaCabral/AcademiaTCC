...
public class NovoProfessor extends javax.swing.JFrame {
    ...
    public NovoProfessor() {
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select max(id) from professor");
            while(rs.next()){
                id = rs.getInt(1);
                id = id + 1;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/new member.png"))); // NOI18N
        jLabel2.setText("Novo Professor");
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 300, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 380, -1, -1));
        ...
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 330, 300, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Horario de Trabalho");
        ...
        getContentPane().add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, 300, -1));
        ...
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, 300, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 300, -1));
        ...
        getContentPane().add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 280, 300, -1));

        lblPainel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Agenda-PainelFundo.png"))); // NOI18N
        getContentPane().add(lblPainel, new org.netbeans.lib.awtextra.AbsoluteConstraints(-90, -10, 860, 520));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String horarioTrabalho = (String)jComboBox2.getSelectedItem();
        try{
            Connection con = ConnectionProvider.getCon();
            ...
            ps.setString(8, horarioTrabalho);
            ps.executeUpdate();
