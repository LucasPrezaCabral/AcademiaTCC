...
public class NovoMembro extends javax.swing.JFrame {
    ...
    public NovoMembro() {
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select max(id) from membro");
            while(rs.next()){
                id = rs.getInt(1);
                id = id + 1;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 180, 300, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 330, 300, -1));

        jComboBox2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06:00-12:00", "13:00-20:00" }));
        getContentPane().add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 230, 300, -1));
        ...
        getContentPane().add(lblPainel, new org.netbeans.lib.awtextra.AbsoluteConstraints(-90, -30, 870, 570));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if (cpf > 0){
                ps.setString(9, cpfString);
            }
            if (idade > 0){
                ps.setString(10, idadeString);
            }
            if (quantia > 0){
                ps.setString(11, quantiaString);
            }
            ps.executeUpdate();
