 ...
 * @author Windows
 */
public class ListaDeMembros extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/list of members.png"))); // NOI18N
        jLabel2.setText("Lista de Membros");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Telefone", "Email", "Sexo", "Cidade", "Endereço", "Horário", "CPF", "Idade", "Quantia"
            }
        ));
        ...
        getContentPane().add(lblPainel, new org.netbeans.lib.awtextra.AbsoluteConstraints(-70, -40, 850, 580));

        setSize(new java.awt.Dimension(751, 500));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaDeMembros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
